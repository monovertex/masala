define([
    ...
    'app/utility/node',
    'app/interaction/actor',
    'app/interaction/camera',
    'app/shading/point',
    'app/shading/spot',
    'app/utility/color',
    'app/shading/material'
],
function (require, _, programConstants, geometryConstants, lightingConstants,
    ...
    return {
        ...
        load: function () {
            ...
            this.sources.backgroundColor = new Color(schema.backgroundColor);
            ...
            if (!_.isUndefined(schema.programs) &&
                ...
                _.forEach(schema.programs, function (program) {
                    ...
                    _.forEach(program.shaders, function (shader, key) {
                        ...
                        require(['text!' + shader], (function (source) {
        ...
        loadMeshes: function () {
            ...
            if (!_.isUndefined(schema.meshes) &&
                ...
                _.forEach(schema.meshes, function (mesh) {
                    ...
                    require(['text!' + source], (function (source) {
